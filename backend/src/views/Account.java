...
public final class Account {
    ...
    private AccountData createAccount() throws Exception {
        return createAccount(100);
    }

    private AccountData createAccount(long initialBalance) throws Exception {
        ...
        accountData.setPublicKey(newAccountKey.getPublicKeyEncodedHex());
        accountData.setPrivateKey(newAccountKey.getSecretKeyHex());

        return accountData;
    }

    private boolean loadContracts() throws Exception {
        Gson gson = new Gson();
    ...
    public static void main (String... arguments) throws Exception {
        final Logger logger = LoggerFactory.getLogger(views.Account.class);

        //DO NOT CHANGE THESE, CHANGE BELOW INSTEAD
        boolean create = false; //OK
        boolean balance = true; //OK
        boolean send = true; //NOK
